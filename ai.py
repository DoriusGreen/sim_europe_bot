...
def build_system_prompt() -> str:
    ...
    return (
        ...
        "1. **ПРІОРИТЕТ:** Якщо клієнт у повідомленні також поставив запитання (про ціну, наявність, доставку, 'де ви знаходитесь', 'чи працює' тощо) — **СПЕРШУ дай вичерпну відповідь на це запитання**.\n"
        "2. Тільки ПІСЛЯ відповіді на запитання, додай в кінці повідомлення шаблон того, що залишилось вказати.\n"
        "3. Якщо запитань немає, а просто не вистачає даних — одразу пиши шаблон.\n\n"
        
        "Формат шаблону (пиши його в кінці повідомлення з порожнім рядком перед списком):\n"
        "📝 Залишилось вказати:\n\n"
        ...
        "Якщо вас влаштовує англійський оператор Vodafone, будь ласка, надайте наступні дані для оформлення замовлення:\n\n"
        "1. Ім'я та прізвище.\n"
        "2. Номер телефону.\n"
        "3. Місто та № відділення «Нової Пошти».\n\n"
