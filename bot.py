...
def build_system_prompt() -> str:
    return (
        ...
        '  "phone": "0XX-XXXX-XXX",\n'
        '  "city": "Місто",\n'
        "Для поля `city` форматуй статус населеного пункту якщо він вказаний клієнтом: 'пгт' або 'смт' перетворюй на 'смт.', 'село' — на 'с.', 'місто' — на 'м.'. Приклад: 'село Тарасівка' -> 'с. Тарасівка', 'пгт Калинівка' -> 'смт. Калинівка', 'місто Київ' -> 'м. Київ'. Якщо статус не вказано, залишай лише назву населеного пункту і все.\n"
        "Якщо вказана область, додай її в дужках. Приклад: 'Буча, Київська область' -> 'Буча (Київська обл.). Назва області завжди з великої літери, а саме скорочення "обл." пиши завжди з маленької.'.\n"
