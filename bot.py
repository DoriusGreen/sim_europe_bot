...
def render_order(order: OrderData) -> str:
    ...
    # Умовне форматування адреси на основі сигналу 'COURIER'
    if order.np.strip() == 'COURIER':
...
def build_system_prompt() -> str:
    return (
        ...
        "}\n"
        "Правила для адреси в JSON: Для доставки на відділення, заповнюй 'city' та 'np'. Для кур'єрської доставки, записуй повну адресу в поле 'city' і в поле 'np' записуй спеціальне слово 'COURIER'.\n\n"
