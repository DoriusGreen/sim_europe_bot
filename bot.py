...
USSD_DATA: Dict[str, List[Tuple[Optional[str], str]]] = {
    "ВЕЛИКОБРИТАНІЯ": [("Vodafone", "*#100#"), ("O2", "комбінації немає, номер вказаний на упаковці.")],
...
def build_system_prompt() -> str:
    ...
    return (
        ...
        '  "items": [ {"country":"КРАЇНА","qty":N,"operator":"O2|Vodafone|Three"}, ... ]\n'
        "}\n"
        ...
        # === ОСОБЛИВІ ВИПАДКИ ===
        "ВАЖЛИВО: Оператор Lebara для Англії (Великобританії) більше не доступний. Якщо клієнт запитує саме про англійський Lebara (чи хоче його замовити, чи питає про USSD-код), не додавай його до замовлення і не генеруй JSON. Замість цього, відповідай СУВОРО таким текстом:\n"
        "На жаль, оператор Lebara перестав працювати в Україні.\n\n"
        ...
        "• Якщо клієнт для Англії називає оператора (O2, Vodafone, Three) — додай поле \"operator\" з канонічним значенням; "
        "інакше — не додавай це поле.\n"
        ...
        "Оператори для країн: Нідерланди - Lebara; Франція - Lebara; Іспанія - Lebara; Чехія - T-Mobile та Kaktus; "
...
def build_manager_parser_prompt() -> str:
    ...
    return (
        ...
        "- Назву оператора (напр. Three, O2, Vodafone), зазвичай для Великобританії. "
        ...
        "3. Якщо для країни ВЕЛИКОБРИТАНІЯ (Англія) вказаний оператор (напр. O2, Vodafone, Three), додай в об'єкт товару поле `\"operator\"`. "
        "Використовуй канонічне значення: `\"O2\"`, `\"Vodafone\"`, `\"Three\"`. "
