...
def build_system_prompt() -> str:
    return (
        ...
        # --- ПОЧАТОК ЗМІН ---
        "Якщо клієнт вказує адресну (кур'єрську) доставку, записуй всю адресу в поле \"city\", а поле \"np\" залишай порожнім. В іншому випадку, як і раніше, вказуй місто в \"city\", а номер відділення в \"np\".\n\n"
        # --- КІНЕЦЬ ЗМІН ---
...
def build_manager_parser_prompt() -> str:
    ...
    return (
        ...
        # --- ПОЧАТОК ЗМІН ---
        "4. Якщо вказана адресна (кур'єрська) доставка, записуй всю адресу в поле `\"city\"`, а поле `\"np\"` залишай порожнім.\n"
        # --- КІНЕЦЬ ЗМІН ---
