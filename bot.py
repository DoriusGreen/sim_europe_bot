...
def build_system_prompt() -> str:
    return (
        ...
        # --------- ОНОВЛЕНИЙ FAQ (використовуй ці формулювання) ---------
        ...
        "Принципової різниці немає, всі сім-карти одразу йдуть зареєстровані (якщо країна потребує реєстрації) та одразу працюють на прийом СМС.\n\n"
        "Це нові сім-карти?\n"
        "Так, наші сім-карти нові, та ніде не використовувались.\n\n"
        "Чи даєте ви гарантії?\n"
        "Звісно! Якщо сім-карта не буде працювати (чого майже не трапляється) то ми або зробимо заміну, або повернемо вам кошти.\n\n"
        "Коли зможете відправити?\n"
        "Зазвичай відправляємо в день замовлення, або протягом 24 годин. В більшості \"Нова Пошта\" доставляє посилки в будь-яку точку України за добу.\n\n"
        "Як оплатити?\n"
        "Зазвичай оплата на \"Новій Пошті\" при отриманні посилки. Але при бажанні, можете оплатити замовлення на карту або в USDT (trc-20).\n\n"
        "Чи можлива відправка в інші країни?\n"
        "В інші країни відправляємо від 3-х штук, потрібна повна предоплата. Відправка через компанію \"Нова Пошта\".\n\n"
        "Як дізнатись свій номер на SIM-карті?\n"
        "Використовуйте такі комбінації (USSD). Якщо країна/оператор не вказані — коротко уточни у клієнта.\n"
        "+44 🇬🇧 UK — *#100# Vodafone/Lebara\n"
        "+44 🇬🇧 UK — комбінації немає, номер вказаний на упаковці. o2\n"
        "+34 🇪🇸 ES — *321# Lebara\n"
        "+34 🇪🇸 ES — *133# Movistar\n"
        "+34 🇪🇸 ES — *321# Lykamobile\n"
        "+49 🇩🇪 DE — *135# Vodafone/Lebara\n"
        "+49 🇩🇪 DE — *132# Lykamobile\n"
        "+31 🇳🇱 NL — *102# Lykamobile\n"
        "+39 🇮🇹 IT — *132# Lykamobile\n"
        "+33 🇫🇷 FR — *144*1# Lebara\n"
        "+420 🇨🇿 CZ — *101# T-mobile\n"
        "+420 🇨🇿 CZ — *103# Kaktus\n"
        "+373 🇲🇩 MD — *444# (потім натиснути 3)\n"
        "+7 🇰🇿 KZ — *120#\n\n"
        # -----------------------------------------------------------------
