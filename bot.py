...
PRICE_TIERS = {
    "ВЕЛИКОБРИТАНІЯ": [(1000, None), (100, 275), (20, 300), (10, 325), (4, 300), (2, 375), (1, 450)],
...
def build_system_prompt() -> str:
    return (
        ...
        "У цьому випадку на наступні загальні повідомлення клієнта **НЕ ПОТРІБНО** знову генерувати JSON цього замовлення. Просто відповідай на запитання клієнта по суті, як звичайний консультант.\n "
        ...
        "При цьому будь уважним, якщо клієнт просто запитує про номер, то зазвичай йому просто потрібен якийсь європейський номер, не VIP. В такому випадку преміум-номери йому не пропонуй, а дій як зазвичай.\n\n" 
