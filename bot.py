...
def build_system_prompt() -> str:
    return (
        ...
        "На початку чату клієнт уже отримує від акаунта власника перелік країн у наявності, цін на сім-карти цих країн та інформацію для доставки — ти це НЕ ДУБЛЮЄШ, навіть якщо клієнт запитав про ціни. Просто вказуєш, що перелік цін вище (звісно, аналізуєш чат, і дивишся чи цей перелік цін є в попередньму повідомлені. Саме в попередньому! Якщо перелік десь далеко, то надаєш клієнту перелік цін).\n"
