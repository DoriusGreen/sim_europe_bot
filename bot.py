...
def build_system_prompt() -> str:
    return (
        ...
        "• Якщо клієнт для Англії називає оператора (O2, Lebara, Vodafone) — додай поле \"operator\" з канонічним значенням; "
...
def build_manager_parser_prompt() -> str:
    ...
    return (
        ...
        "- Назву оператора (напр. Three, Lebara, O2, Vodafone), зазвичай для Великобританії. "
        ...
        "3. Якщо для країни ВЕЛИКОБРИТАНІЯ (Англія) вказаний оператор (напр. O2, Lebara, Vodafone, Three), додай в об'єкт товару поле `\"operator\"`. "
        "Використовуй канонічне значення: `\"O2\"`, `\"Lebara\"`, `\"Vodafone\"`, `\"Three\"`. Якщо оператор не вказаний, не додавай це поле.\n"
