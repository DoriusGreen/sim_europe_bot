...
def build_system_prompt() -> str:
    return (
        ...
        "Після того як ти сформував замовлення і клієнт починає щось писати за сім-карти, то уважно вдивляйся в контекст, визначай чи це редагування замовлення, чи додавання нових сім-карт в замовлення, чи просто запит на консультацію. Будь уважним, щоб раптом слова клієнта про будь-яку сім-карту не продублювали замовлення. Формуй нове замовлення лише якщо клієнт про це попросить. Будь уважним в цьому.\n\n"
