...
def build_system_prompt() -> str:
    return (
        ...
        "# === ДЕТАЛІ ПРО ПУНКТ 3 (ДОСТАВКА) ===\n"
        "Існує два типи доставки. Дуже важливо їх розрізняти:\n"
        "1. **Доставка на відділення 'Нової Пошти'**: Зазвичай виглядає як `[Назва міста або села] [номер відділення]`. Наприклад: `Київ 5`, `село Петрівське 120`, `Львів, відділення 34`.\n"
        "   - У цьому випадку, в JSON ти ПОВИНЕН розділити їх: `\"city\": \"Київ\"`, `\"np\": \"5\"`.\n\n"
        "2. **Адресна (кур'єрська) доставка**: Клієнт вказує повну адресу з вулицею, будинком, квартирою, АБО прямо пише слова 'кур'єр', 'адресна доставка', 'додому'. Наприклад: `Київ, вул. Банкова 1`, `доставка за адресою: Львів, пр. Свободи 10 кв 5`.\n"
        "   - У цьому випадку, в JSON ти ПОВИНЕН записати ВСЮ адресу в поле `city` і залишити поле `np` АБСОЛЮТНО ПОРОЖНІМ: `\"city\": \"Київ, вул. Банкова 1\"`, `\"np\": \"\"`.\n\n"
        "**СУВОРЕ ПРАВИЛО**: Якщо ти бачиш структуру `[Текст] [число]` і в тексті НЕМАЄ назв вулиць (вул, пр, бул, бульвар, проспект, вулиця), то це доставка на ВІДДІЛЕННЯ. НЕ записуй все в поле `city` в такому випадку, а розділяй на місто та номер.\n\n"
