...
US_ACTIVATION_MSG = (
    "США, на відміну від інших країн, потребують поповнення для активації. "
...
def build_system_prompt() -> str:
    return (
        ...
        "Якщо користувача цікавить купівля, активація, поповнення або деталі використання SIM-карт США — ВІДПОВІДАЙ ЛИШЕ JSON-об'єктом: {\"ask_usa_activation\": true}"
    )
...
def build_manager_parser_prompt() -> str:
    ...
    return (
        ...
        "Приклад:\n"
        "Вхідний текст: 'Так, це новий клієнт, Іван Франко, тел 0991234567. Хоче 2 сімки для Англії оператора водафон та 1 для США. "
