...
# ==== РЕКЛАМНЕ ПОВІДОМЛЕННЯ (PROMO) ====
PROMO_TEXT = (
    "🔥 <b>Хочеш підпалити Росію? Тепер можеш!</b>\n\n"
    "Долучайтесь до нашого інтерактивного благодійного проєкту на підтримку 40-ї ОАБр ім. Великого князя Вітовта.\n\n"
    "🔥 Впишіть своє ім'я в історію паліїв Росії!\n\n"
    "burnmoscow.com"
)
