...
COUNTRY_AVAILABILITY = {
    ...
    "ІСПАНІЯ":         {"status": "-", "reason": "Очікуються."},
    "ЧЕХІЯ":           {"status": "+", "reason": ""},
...
CRYPTO_UAH_RATE = 44    # 1 USD = 43 UAH
